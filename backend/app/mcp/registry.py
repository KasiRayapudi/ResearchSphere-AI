...
class MCPConnectorRegistry:
    ...
    def list_all_connectors(self) -> list[dict[str, Any]]:
        ...
        future = [
            ...
            {
                "connector_id": "mcp-notion-05",
                "name": "Notion AI Workspace Sync",
                "provider": "notion",
                "status": "disconnected",
                "synced_count": 0,
                "is_future_connector": True,
            ...
            {
                "connector_id": "mcp-gmail-08",
                "name": "Gmail Enterprise Search",
                "provider": "gmail",
                "status": "disconnected",
                "synced_count": 0,
                "is_future_connector": True,
